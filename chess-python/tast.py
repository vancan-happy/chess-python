...
def setBoard(dic, cord, imgl1, rects1, typeL1, position="rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"):
    ...
    return imgl, rects, typeL, whomove, castel, encrassont, halfm, mov
        ...
        if event.type == MOUSEBUTTONDOWN:
            if event.button == 1:
                ...
                if movingbox is not None:
                    legalMoves = legalMoveF(move, picType, grid, legalm[1], legalm[0], castlelis, ensq, typeL, rects)
